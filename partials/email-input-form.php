...
<form class="row" action="https://www.salesforce.com/servlet/servlet.WebToLead?encoding=UTF-8" method="POST" class="form-inline" role="form" target="hidden_iframe" onsubmit="submitted = true">
    ...
    <button type="submit" name="submit" class="col-xs-3 btn gs-btn gs-btn-orange">Submit</button>
    <input type="hidden" name="oid" value="00DU0000000H5SC">
    <input type="hidden" name="lead_source"  value="Groundswell">
</form>
