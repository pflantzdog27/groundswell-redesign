...
<?php include_once('partials/primary-navigation.php'); ?>
    ...
    <header id="intro-section-wrapper">
        ...
        <div id="sub-intro-section">
            <div class="container">
                <p>Groundswell is a growing online community of nearly 100,000 people who believe faith can be a force for good in the world. We offer tools and training for organizing online, and share the best faithful justice content on the Web daily. Powered by <a href="#">Auburn Seminary</a>. </p>
            ...
            <div class="section-template content-overlay-section row">
                ...
                <div class="section-overlay">
                    <article>
                        ...
                        <p>Isaac’s training on organizing in a modern age helped us grapple with how to integrate digital strategies with on-the-ground organizing. The Jewish Organizing Fellows loved Isaac’s interactive exercises and his real world stories of successful online organizing campaigns.</p>
        ...
        <div class="container">
            <div class="section-template parallax three-column-section row">
                ...
                <div class="col-sm-4 blog-post">
                    <article>
                        <figure>
                            <img class="img-responsive" src="http://placehold.it/500x250" alt="Title">
                        </figure>
